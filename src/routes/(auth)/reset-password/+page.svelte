...
<div class="flex flex-col justify-center items-center">
	...
	<div class="mt-6">
		...
		<form method="post" class="mt-2 flex flex-col gap-4" use:enhance>
			<div>
				<label for="new-password" class="px-2 py-2">New Password</label>
				<input
			...
			<div>
				<label for="confirm-password" class="px-2 py-2">Confirm Password</label>
				<input
					class="bg-dark px-2 py-1 w-full"
					type="password"
					id="confirm-password"
			...
			<div class="flex flex-row items-center gap-4 mt-2">
				<button class="bg-amber-500 text-black text-lg px-4 py-1">Update Password</button>
			</div>
		</form>
	</div>
</div>

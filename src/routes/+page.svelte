...
<div class="p-2 min-h-screen w-screen flex flex-col text-primary">
	<div class="pb-4">
		<div class="flex flex-row items-center gap-4">
			...
			<select class="bg-dark px-1 py-1" bind:value={config.type}>
				<option selected value="plaintext">Plain Text</option>
			</select>

			<button class="btn underline underline-offset-4 py-1" title="{cmdKey}+N">New</button>
			<button class="btn underline underline-offset-4 px-2 py-1" title="{cmdKey}+N">Info</button>
			<button
